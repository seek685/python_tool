...
5. 换号测试: 直接改输入, 再点一次"开始监听"即可, 无需先停止。
...
class App(tk.Tk):
    ...
    def _build_widgets(self):
        ...
        self.ent_user = ttk.Entry(row1, width=20)
        self.ent_user.pack(side=tk.LEFT, padx=(4, 16))
        ttk.Label(row1, text="密码:").pack(side=tk.LEFT)
        self.ent_pass = ttk.Entry(row1, width=20, show="*")
